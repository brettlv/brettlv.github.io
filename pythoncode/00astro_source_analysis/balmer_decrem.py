...
__all__ = ["eBmV_dc", "Alamda", "Factor_obs2int"]
...
def eBmV_dc(ld_obs, ld_int=3.1, wave_l1=wave_Ha, wave_l2=wave_Hb, Rv=3.1, ecname="fitzpatrick99"):
    """
...
def Alamda(wavelength, eBmV, Rv=3.1, ecname="fitzpatrick99"):
    """
